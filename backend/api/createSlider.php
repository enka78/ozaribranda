...
if(isset($postdata) && !empty($postdata))
{
    ...
    $sliderActive = mysqli_real_escape_string($con, $request->active);
    $sira = mysqli_real_escape_string($con, $request->sira);


    // Create.
    $sql = "INSERT INTO `slider`(`id`,`sliderText1`,`sliderText2`, `sliderimg`, `active`, `sira`) VALUES (null,'{$hakimizda}','{$vizyonumuz}','{$misyonumuz}','{$aktif}', '{$sira}')";
